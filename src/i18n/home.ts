export const homeUI = {
  ...
  ja: {
    ...
    'home.meta.description':
      'オープンソース、AI対応の台湾総合ナレッジベース。87以上の深掘り記事が歴史・文化・グルメ・音楽・テクノロジーなど12大テーマを網羅し、コミュニティが共同編集して台湾の真の姿を世界に紹介します。',
  ...
  ko: {
    ...
    'home.meta.description':
      '오픈소스, AI 친화적인 대만 종합 지식 베이스. 87+ 심층 기사가 역사·문화·미식·음악·기술 등 12대 주제를 다루며, 커뮤니티가 공동 편찬하여 진정한 대만을 세계에 소개합니다.',
  ...
  fr: {
    ...
    'home.meta.description':
      "Base de connaissances open source et adaptée aux IA sur Taïwan. Plus de 87 pages de contenu approfondi couvrant l'histoire, la culture, la gastronomie, la musique, la technologie et 12 grands thèmes, co-éditées par la communauté pour faire découvrir le vrai Taïwan au monde.",
  ...
  es: {
    ...
    'home.meta.description':
      'Base de conocimiento de código abierto y compatible con IA sobre Taiwán. Más de 87 páginas de contenido en profundidad que cubren historia, cultura, gastronomía, música, tecnología y 12 grandes temas, co-editadas por la comunidad para presentar al mundo el verdadero Taiwán.',
