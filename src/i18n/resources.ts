export const resourcesUI = {
  en: {
    // Meta
    'resources.meta.title': 'Taiwan Resources Guide - COMPUTEX.md',
    ...
    'resources.category.taiwanmd.label': '📡 COMPUTEX.md Related',
    ...
    'resources.chapter.community.story':
      "g0v's motto: 'Don't ask why nobody is doing this — you are that nobody.' Mask maps, fact-checking bots, election promise trackers — all born from weekend hackathons. In Taiwan, civic participation looks like this: writing code, opening issues, submitting pull requests. COMPUTEX.md is a product of this very spirit.",
    ...
    'resources.site.taiwanmd': 'COMPUTEX.md',
  },
  ja: {
    // Meta
    'resources.meta.title': '台湾リソースガイド - COMPUTEX.md',
    'resources.meta.description':
    ...
    'resources.category.taiwanmd.label': '📡 COMPUTEX.md 関連',
    ...
    'resources.chapter.community.story':
      'g0v のモットーは「なぜ誰もやらないのかと問うな。あなたがその"誰も"だ」。マスクマップ、ファクトチェックボット、選挙公約トラッカー――すべて週末ハッカソンから生まれた。台湾では市民参加はこういう形をとる：コードを書き、Issue を立て、Pull Request を送る。COMPUTEX.md もまさにこの精神の産物だ。',
  ...
  ko: {
    // Meta
    'resources.meta.title': '대만 리소스 가이드 - COMPUTEX.md',
    'resources.meta.description':
    ...
    'resources.category.taiwanmd.label': '📡 COMPUTEX.md 관련',
    ...
    'resources.chapter.community.story':
      "g0v 영시정부의 모토는 「아무도 안 하냐고 묻지 말라, 당신이 바로 그 '아무도'니까.」 마스크 지도, 팩트체크 봇, 선거 공약 추적기 — 모두 주말 해커톤에서 탄생했다. 대만에서 시민 참여란 이런 것이다: 코드를 짜고, Issue를 열고, Pull Request를 보낸다. COMPUTEX.md도 바로 이 정신의 산물이다.",
  ...
  vi: {
    // Meta
    'resources.meta.title': 'Cẩm nang tài nguyên Đài Loan - COMPUTEX.md',
    'resources.meta.description':
    ...
    'resources.category.taiwanmd.label': '📡 Liên quan đến COMPUTEX.md',
  ...
  id: {
    // Meta
    'resources.meta.title': 'Panduan Sumber Daya Taiwan - COMPUTEX.md',
    'resources.meta.description':
    ...
    'resources.category.taiwanmd.label': '📡 Terkait COMPUTEX.md',
    ...
    'resources.chapter.community.story':
      'Moto g0v adalah “Jangan bertanya mengapa tidak ada yang mengerjakannya, karena Andalah si ‘tidak ada’ itu.” Peta masker, bot pemeriksa berita palsu, dan pelacak janji pemilu, semuanya lahir dari hackathon akhir pekan. Di Taiwan, partisipasi warga berbentuk seperti ini: menulis program, membuka Issue, dan mengirim Pull Request. COMPUTEX.md juga merupakan buah dari semangat ini.',
  ...
  pt: {
    // Meta
    'resources.meta.title': 'Guia de recursos de Taiwan - COMPUTEX.md',
    'resources.meta.description':
    ...
    'resources.category.taiwanmd.label': '📡 Sobre COMPUTEX.md',
    ...
    'resources.chapter.community.story':
      'O motto do g0v, o “governo zero”, é: “Não pergunte por que ninguém está fazendo isso, pois você é esse ‘ninguém’.” Mapas de disponibilidade de máscaras, robôs de verificação de notícias falsas e rastreadores de promessas eleitorais: tudo nasceu em hackathons de fim de semana. Em Taiwan, a participação cívica é assim: escrever código, abrir Issue e enviar Pull Request. COMPUTEX.md também é fruto desse espírito.',
  ...
  hi: {
    // Meta
    'resources.meta.title': 'ताइवान संसाधन मार्गदर्शिका - COMPUTEX.md',
    'resources.meta.description':
    ...
    'resources.category.taiwanmd.label': '📡 COMPUTEX.md से संबंधित',
  ...
  ar: {
    // Meta
    'resources.meta.title': 'دليل الموارد التايوانية - COMPUTEX.md',
    'resources.meta.description':
    ...
    'resources.category.taiwanmd.label': '📡 متعلق بـ COMPUTEX.md',
  ...
  ru: {
    // Meta
    'resources.meta.title': 'Навигатор по ресурсам Тайваня — COMPUTEX.md',
    'resources.meta.description':
    ...
    'resources.category.taiwanmd.label': '📡 Связанные с COMPUTEX.md',
    ...
    'resources.chapter.community.story':
      'Девиз g0v Zero Hour Government гласит: «Не спрашивайте, почему никто не делает этого, потому что вы и есть тот самый „никто“». Карты масок, боты для проверки фейковых новостей, трекеры избирательных обещаний — все это создано на выходных хакатонах. На Тайване гражданское участие выглядит так: пишешь код, создаешь Issue, отправляешь Pull Request. COMPUTEX.md также является продуктом этого духа.',
  ...
  'zh-TW': {
    // Meta
    'resources.meta.title': '台灣資源導覽 - COMPUTEX.md',
    'resources.meta.description':
    ...
    'resources.category.taiwanmd.label': '📡 COMPUTEX.md 相關',
    ...
    'resources.chapter.community.story':
      'g0v 零時政府的 motto 是「不要問為什麼沒有人做這個，因為你就是那個『沒有人』。」口罩地圖、假新聞查核機器人、選舉承諾追蹤器，全部出自週末黑客松。在台灣，公民參與長這樣：寫程式、開 Issue、發 Pull Request。COMPUTEX.md 也是這個精神的產物。',
  ...
  es: {
    'resources.meta.title': 'Guía de recursos de Taiwán - COMPUTEX.md',
    'resources.meta.description':
    ...
    'resources.category.taiwanmd.label': '📡 Relacionado con COMPUTEX.md',
  ...
  fr: {
    'resources.meta.title': 'Guide des ressources de Taïwan - COMPUTEX.md',
    'resources.meta.description':
    ...
    'resources.category.taiwanmd.label': '📡 Lié à COMPUTEX.md',
    ...
    'resources.chapter.community.story':
      'La devise de g0v : « Ne demandez pourquoi personne ne le faites — vous êtes ce personne. » Cartes de masques, bots de vérification des faits, suiveurs de promesses électorales — tous nés de hackathons du week-end. À Taïwan, la participation civique ressemble à cela : écrire du code, ouvrir des tickets, soumettre des pull requests. COMPUTEX.md est un produit de cet esprit même.',
    'resources.insight.gov.branches.number': '5',
