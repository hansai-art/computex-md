...
export const ui = {
  en: {
    ...
    'nav.organism-view': 'The Organism',
    ...
    'nav.about.charter': 'Editorial charter',
    'nav.about.faq': 'FAQ',
    ...
    'nav.contribute.how': 'How to send a correction',
    'nav.contribute.rules': 'What this site does not do',
    'footer.explore': 'Explore',
    'footer.project': 'Project',
    'footer.about': 'About',
    'footer.organism': 'The Organism',
  ...
  'zh-TW': {
    ...
    'nav.contribute.how': '怎麼送出勘誤',
    'nav.contribute.rules': '本站不做的事',
    'footer.explore': '探索',
    'footer.project': '專案',
    'footer.about': '關於',
    'footer.organism': '生命體',
