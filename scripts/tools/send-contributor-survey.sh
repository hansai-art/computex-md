...
👋 Hi @USERNAME, your first PR has been merged — thank you for becoming a COMPUTEX.md clownfish 🐠

We want to understand contributor stories to help COMPUTEX.md become a better community. If you have 2 minutes, could you answer some of these questions in a comment? Any single answer is valuable — you don't have to answer all.

---

**1. How did you find COMPUTEX.md?**
...
👋 こんにちは @USERNAME, 最初の PR がマージされました。COMPUTEX.md のクマノミ 🐠 になってくれてありがとうございます。

寄稿者の物語を知りたいので、2 分ほどあれば以下の質問に答えていただけますか？一つだけでも構いません。

---

**1. COMPUTEX.md をどうやって見つけましたか?**
検索? 友人の紹介? SNS? どの記事?
